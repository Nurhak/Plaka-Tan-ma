...
bool loadKNNDataAndTrainKNN(void) {
    ...
    cv::FileStorage fsClassifications("D:\\Visual Studio Projects\\licPlaterec\\classifications.xml", cv::FileStorage::READ);        // open the classifications file
